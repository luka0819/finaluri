...
import com.example.myapplication.VideoEditor.filter.GlBitmapOverlaySample;
...
public enum FilterType {
    ...
    public static GlFilter createGlFilter(FilterType filterType, Context context) {
        switch (filterType) {
            ...
            case WATERMARK:
                return new GlWatermarkFilter(BitmapFactory.decodeResource(context.getResources(), R.drawable.add ), GlWatermarkFilter.Position.RIGHT_BOTTOM);
            case WEAK_PIXEL:
            ...
            case BITMAP_OVERLAY_SAMPLE:
                return new GlBitmapOverlaySample(BitmapFactory.decodeResource(context.getResources(), R.drawable.add));
            default:
                return new GlFilter();
        }
    }
